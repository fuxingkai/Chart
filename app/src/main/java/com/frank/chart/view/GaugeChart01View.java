...
public class GaugeChart01View extends GraphicalView {
    ...
    public void chartRender() {
        try {
            ...
            //指针圆圈的paint
            Paint circlePaint = chart.getPinterCirclePaint();
            circlePaint.setColor(Color.parseColor("#4d2463"));

            //指针paint
            Paint fillPaint = chart.getPartitionFillPaint();
            fillPaint.setColor(Color.parseColor("#ffffff"));

            //刻度外圈的paint
            Paint dountPaint = chart.getDountPaint();
            dountPaint.setColor(Color.parseColor("#4d2463"));

            //刻度的paint
            Paint tickPaint = chart.getTickPaint();
            tickPaint.setColor(Color.parseColor("#ff0000"));
