...
public class CircleChartActivity extends Activity {
	...
	//半圆
	com.frank.chart.view.CircleChart01View halfchart = null;
	
	
	//圆
	com.frank.chart.view.CircleChart02View chart = null;
	
	//半圆
	com.frank.chart.view.CircleChart03View halfchart2 = null;
	...
	private void init()
	{
		halfchart = (com.frank.chart.view.CircleChart01View)findViewById(R.id.halfcircle_view);
		chart = (com.frank.chart.view.CircleChart02View)findViewById(R.id.circle_view);
		halfchart2 = (com.frank.chart.view.CircleChart03View)findViewById(R.id.halfcircle_view2);
